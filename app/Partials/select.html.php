<style>
    .nice-select { height: 49px !important; line-height: 44px !important; font-size: 16px !important; margin-top: 1px !important; border: 2px solid #D1D5DB !important; color: #393a3d; }
</style>

<div class="<?= $size ?? '' ?>">
    <label class="block px-1 text-sm text-gray-600 mt-0.5" for="<?= $name ?>"><?= $label ?></label>
