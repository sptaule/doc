        ...
        <form action="" method="post" class="space-y-10">
                    ...
                    <div class="bg-teal-50 shadow-md p-2 flex flex-col items-start justify-center">
                        {{ partial('checkbox', [
                            ...
                            'subLabel' =>
                                ...
                                lors d'une inscription à un évènement de ce type<br>
            ...
            <div class="border-l-2 border-green-400 pl-4 w-full space-y-4">
                ...
                <p class="text-gray-500 text-sm italic">
                    Cochez tous les documents que l'utilisateur <u>doit posséder</u> pour pouvoir s'inscrire à un évènement de ce type.
            ...
            <div class="border-l-2 border-green-400 pl-4 w-full space-y-4">
                ...
                <p class="text-gray-500 text-sm italic">
                    Cochez tous les grades autorisés à participer à un évènement de ce type.
